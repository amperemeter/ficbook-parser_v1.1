...
Если вы хотите отслеживать появление работ с определенными параметрами, вы должны будете использовать третьий вид парсера из папки filter. Инструкция по его использованию та же, что и для парсера в папке mongodb. Для просмотра инструкции перейдите по [данной ссылке](mongodb/README-MONGODB.md). 
