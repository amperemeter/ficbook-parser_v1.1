...
5. Создать на случай непредвиденных ошибок копию файла `fanfics.json` (по желанию).
#### Запустить парсер 
6. Запустить парсер в терминале стандартной командой `[node index.js]` или `[node .]`. Первый запуск парсера добавит количество фанфиков в базу данных. Последующие запуски отобразят количество новых фанфиков при их наличии.
